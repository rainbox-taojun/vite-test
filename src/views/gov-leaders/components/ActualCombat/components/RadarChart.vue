...
const data1 = ref([78, 85.5, 91, 72.5, 66.5])
const yData = ref([
  '联系群众解民忧',
  '民主会商定政策',
  '依法监督惠民生',
    ...
    radar: {
      ...
      name: {
        ...
        formatter: function (name) {
          ...
          return '{a|' + name + '} {b|' + data1.value[index] + '}'
        },
        rich: {
          a: {
            align: 'center',
...
const { refreshChart } = useEcharts('actual-combat-radar-chart', options.value)
